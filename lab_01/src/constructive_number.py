...
class ConstructiveNumber:
    ...
    def __add__(
        self, other: Union["ConstructiveNumber", float, int]
    ) -> "ConstructiveNumber":
        """
        ...
        if isinstance(other, (float, int)):
            ...
            return ConstructiveNumber(
                self.a + other.a, self.b + other.b, is_interval=True
            )
    ...
    def __sub__(
        ...
        if isinstance(other, (float, int)):
            ...
            return ConstructiveNumber(
                self.a - other.b, self.b - other.a, is_interval=True
            )
    ...
    def __mul__(
        ...
        if isinstance(other, (float, int)):
            ...
            p4 = self.b * other.b
            return ConstructiveNumber(
                min(p1, p2, p3, p4), max(p1, p2, p3, p4), is_interval=True
            )
        ...
        if isinstance(other, (float, int)):
            ...
            if other.a <= 0 <= other.b:
                raise ZeroDivisionError(
                    "Интервал-делитель содержит ноль! Деление невозможно!!!"
                )
            # Деление на [c, d] = умножение на [1/d, 1/c]
            inverse_other = ConstructiveNumber(
                1.0 / other.b, 1.0 / other.a, is_interval=True
            )
    ...
    def __rtruediv__(self, other: Union[float, int]) -> "ConstructiveNumber":
        ...
        if isinstance(other, (float, int)):
            ...
            inverse_self = ConstructiveNumber(
                1.0 / self.b, 1.0 / self.a, is_interval=True
            )
